...
/**
 * @brief Inicia a entrada de leitura e escrita de dados.
 *
 * Esta função inicia um loop de leitura de entrada do usuário e envio de dados por meio da conexão BLE.
 * Ela manipula a descoberta de serviços e características, a subscrição de notificações e o envio de dados.
 */
...
/**
 * @brief Manipula a descoberta de dispositivos BLE.
 *
 * Esta função é chamada quando um dispositivo BLE é encontrado durante a digitalização.
 * Ela extrai informações do dispositivo, como o endereço e o RSSI, e decide se deve criar uma conexão BLE com o dispositivo.
 *
 * @param addr O endereço do dispositivo BLE encontrado.
 * @param rssi O valor do RSSI (Received Signal Strength Indicator) do sinal do dispositivo.
 * @param type O tipo de anúncio BLE.
 * @param ad Um ponteiro para o pacote de dados do anúncio.
 */
 ...
 *
 * Esta é a função principal do programa que inicializa o Bluetooth LE, inicia a digitalização BLE
 * e inicia o loop de leitura e escrita de dados BLE.
 */
void main(void)
{
	int error;
